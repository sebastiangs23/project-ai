...
export function ToolCard({ card }: ToolCardProps) {
  return (
    <article className="group relative h-[320px] overflow-hidden rounded-[28px] border border-zinc-900 bg-zinc-950 transition duration-300 ease-out hover:scale-[1.03] hover:border-[#2065D1]/70 hover:shadow-[0_0_35px_rgba(32,101,209,0.45)] md:h-[375px]">
      <video
      ...
      <div className="absolute left-5 top-5 flex h-12 w-12 items-center justify-center rounded-full border border-white/60 bg-white/20 text-2xl text-white backdrop-blur-sm transition duration-300 group-hover:bg-white/30">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6">
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          >
            ...
            <FiArrowRight className="text-xl transition duration-300 ease-out group-hover:-rotate-[35deg]" />
          </button>
        </div>
      </div>
    </article>
